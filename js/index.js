...
import { getPosts, savePost, updatePost, deletePost, getPostView} from './firebase/firebase.js';
...
buttonSavePost.addEventListener('click', (event) => {
    ...
    const post = new Post(username, userImg, date, title, tags, likes, comments, reading, headerImg, description, postImg, marked);
    savePost(post);
